document.addEventListener('DOMContentLoaded', () => {
    ...
    const expertiseData = [
        { title: "Relationship Building & Collaboration", icon: "🤝", description: "Bring people together to discuss important issues and get things done.", longDescription: "Placeholder text for Relationship Building & Collaboration. This section could include details about my experience in fostering cross-functional teamwork, mediating discussions, and building consensus among diverse stakeholders to achieve common goals. I excel at creating an environment where ideas are shared freely and collaboration thrives." },
        { title: "Reflection & Feedback", icon: "🔍", description: "Self-reflect, give emotionally intelligent feedback and speak up for change.", longDescription: "Placeholder text for Reflection & Feedback. Here, I would elaborate on my commitment to continuous self-improvement, my structured approach to giving and receiving constructive feedback, and my proactive stance in advocating for necessary organizational and process changes based on critical analysis." },
        { title: "Innovation & Strategy Development", icon: "🚀", description: "Business innovation, corporate strategy, and tech development.", longDescription: "Placeholder text for Innovation & Strategy Development. This involves my expertise in identifying emerging trends, conceptualizing new business models, formulating long-term strategic plans, and overseeing the development of cutting-edge technological solutions to drive growth and efficiency." },
        { title: "Leadership & Hospitality", icon: "🌟", description: "Culture building, people development and service excellence.", longDescription: "Placeholder text for Leadership & Hospitality. This section would detail my experience in nurturing positive team cultures, mentoring and developing talent, effectively managing diverse teams, and consistently delivering exceptional service experiences that exceed guest expectations and build brand loyalty." },
        { title: "Financial & Business Analysis", icon: "📊", description: "Feasibility studies, financial modeling, and asset management.", longDescription: "Placeholder text for Financial & Business Analysis. This includes my proficiency in conducting thorough financial feasibility studies, developing robust financial models for investment decisions, and implementing effective asset management strategies to optimize performance and maximize returns for hospitality and real estate ventures." }
    ];
